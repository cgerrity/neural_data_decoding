...
Currently **550 tests pass** in the default suite (plus 4 MATLAB-gated parity
...
| CC — Extra-credit features | 🚧 In progress — SGDM #1, MAE #2, S&F Phase 1 Feedforward, data restructure to (W, T, A, C); true per-window 2D conv encoder + S&F Default + Gemini pending |
